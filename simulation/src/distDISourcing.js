...
function Diagram32() {
    ...
    $("#Header").html("<center><span>DISTILATION DI SOURCING</span></center>");
  ...
  document.getElementById("startBtn").addEventListener("click", () => {
    ...
    const requirements = [
        ...
        },
        {
            zoneId: "CARD1",
            requirements: [
                { from: { type: "CARD", port: "one" }, to: { type: "POSNEG", port: "right" } },
                { from: { type: "CARD", port: "two" }, to: { type: "POSNEGP", port: "bottom" } },
                { from: { type: "CARD", port: "three" }, to: { type: "I1P", port: "top" } },
                { from: { type: "CARD", port: "four" }, to: { type: "I2P", port: "top" } },
                { from: { type: "CARD", port: "five" }, to: { type: "I3P", port: "top" } }
            ]
        },
        {
            zoneId: "I6P2",
...
//	  alert(" All required connections are correct! ");
        ...
        $("#startBtn").prop("hidden",true);
         ...
         resultJson.demo3 = mimicCount2;
        console.log(resultJson);
        
        timerMasterJson.demo3 = $("#counter").text();
		console.log(timerMasterJson);
		seconds = 0;
		updateCounter();
         
	  
	  var htm = `<img src='images/sprayDryerDISourcing.png' class='img-fluid' 
...
//		alert("image");
         ...
         Swal.fire({
					...
					html: `<div>
                <img src='images/sprayDryerDISourcing.png' class='img-fluid' 
