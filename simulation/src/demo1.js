...
var mimicCount1 = 0;
 function Diagram1() {
    ...
    $("#Header").html("<center><span>BOILER DO SINKING</span></center>");
    ...
    if (allValid) {
	  ...
	  resultJson.demo1 = mimicCount1;
        ...
        timerMasterJson.demo1 = $("#counter").text();
				...
				seconds = 0;
				updateCounter();
	  var htm = `<img src='images/doSinking.png' class='img-fluid' 
       ...
       $("#startBtn2").prop("hidden",true);
        ...
        if (wrongCnt1 < 3) {
            ...
            Swal.fire({
                ...
                html: `<div>
                    <img src='images/doSinking.png' class='img-fluid' 
