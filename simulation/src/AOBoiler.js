...
function aoBoiler() {
    ...
    $("#Header").html("<center><span>BOILER AO</span></center>");
        ...
        Swal.fire({
            ...
            customClass: {
	         ...
	         Swal.fire({
					...
					html: `<div>
                <img src='images/AODiagram.png' class='img-fluid' 
