...
function Diagram4() {
    ...
    $("#Header").html("<center><span>BOILER DO SOURCING</span></center>");
...
//	  alert(" All required connections are correct! ");
	  ...
	  var htm = `<img src='images/doSourcing.png' class='img-fluid' 
...
//		alert("image");
         ...
         Swal.fire({
					...
					html: `<div>
                <img src='images/doSourcing.png' class='img-fluid' 
