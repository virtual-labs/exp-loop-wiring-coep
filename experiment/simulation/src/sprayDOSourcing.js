...
function Diagram41() {
    ...
    $("#Header").html("<center><span>SPRAY DRYER DO SOURCING</span></center>");
...
//	  alert(" All required connections are correct! ");
	  ...
	  var htm = `<img src='images/sprayDOSourcing.png' class='img-fluid' 
...
//		alert("image");
         ...
         Swal.fire({
					...
					html: `<div>
                <img src='images/sprayDOSourcing.png' class='img-fluid' 
