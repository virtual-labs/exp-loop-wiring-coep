...
var mimicCount3 = 0;
 ...
 function Diagram12() {
    ...
    $("#Header").html("<center><span>DISTILATION DO SINKING</span></center>");
...
//placedElements.push();
  ...
  document.getElementById("startBtn2").addEventListener("click", () => {
    ...
    if (allValid) {
	  ...
	  var htm = `<img src='images/distDOSinking.png' class='img-fluid' 
       ...
       $("#startBtn2").prop("hidden",true);
        ...
        if (wrongCnt1 < 3) {
            ...
            Swal.fire({
                ...
                html: `<div>
                    <img src='images/distDOSinking.png' class='img-fluid' 
