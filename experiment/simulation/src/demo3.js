...
function Diagram3() {
    ...
    $("#Header").html("<center><span>BOILER DI SOURCING</span></center>");
...
//	  alert(" All required connections are correct! ");
	  ...
	  var htm = `<img src='images/diSourcing.png' class='img-fluid' 
...
//		alert("image");
         ...
         Swal.fire({
					...
					html: `<div>
                <img src='images/diSourcing.png' class='img-fluid' 
